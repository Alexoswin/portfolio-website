    ...
    <div className="form-container">
      <form className="form-card">
        ...
        <div className="input-group">
          ...
          </svg> <input type="text" placeholder="Project Title" required />
        </div>
        ...
        <div className="input-group">
          ...
          </svg> <input type="text" placeholder="Description" required />
        </div>
        ...
        <div className="input-group">
          ...
          </svg> <input type="text" placeholder="Tech Stack" required />
        </div>
        ...
        <div className="input-group">
          ...
          </svg> <input type="text" placeholder="GitHub URL" required />
        </div>
        ...
        <div className="input-group">
          ...
          </svg> <input type="text" placeholder="Image URL" required />
        </div>
