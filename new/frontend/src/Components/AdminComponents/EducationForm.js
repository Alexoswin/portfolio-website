...
export default function EducationForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(formData); // Replace with Axios POST later
  };
    ...
    <div className="form-container">
      <form className="form-card" onSubmit={handleSubmit}>
        ...
        <div className="input-group">
          ...
          <input type="text" name="institution" placeholder="Institution" required value={formData.institution} onChange={handleChange} />
        </div>
        ...
        <div className="input-group">
          ...
          <input type="text" name="degree" placeholder="Degree" required value={formData.degree} onChange={handleChange} />
        </div>
        ...
        <div className="input-group">
            ...
            <input type="text" name="marks" placeholder="Marks / GPA" value={formData.marks} onChange={handleChange} />
        </div>
